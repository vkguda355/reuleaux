...
using namespace std;
std::vector<bool> dummyvariable(8,false);
...
public:
  ...
  bool isIKSuccess(const std::vector<double> &pose, std::vector<double> &joints, int& numOfSolns, std::vector<bool> &configsFound = dummyvariable);
